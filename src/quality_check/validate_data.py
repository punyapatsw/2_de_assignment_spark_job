...
def compute_stats(spark:'spark.Session',tbl_name:str,data_date:str):
...
def validate_data(spark:'spark.Session',df:'spark.DataFrame',tbl_name:str,data_date:str,col:str):
    count_df = df.count()
